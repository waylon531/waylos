...
extern {
    fn setup_registers(page_addr: u64, instruction_addr: u64);
    fn save_registers();
...
unsafe fn create_thread_memory_area(page_addr: u64,addr: u64) {
    loop{}
    ...
    loop {}
    setup_registers(page_addr,addr); //Also sets up the stack and cr3
}
#[no_mangle]
...
#[no_mangle]
pub extern fn kernel_thread_create(addr: u64) {
    unsafe {
        //save_registers();
        create_thread_memory_area(memory::palloc(),addr); //Setup page table
        loop {}
